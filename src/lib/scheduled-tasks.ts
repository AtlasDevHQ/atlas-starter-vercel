...
function rowToScheduledTask(r: Record<string, unknown>): ScheduledTask {
  ...
  return {
    ...
    lastRunAt: r.last_run_at ? String(r.last_run_at as string | Date) : null,
    nextRunAt: r.next_run_at ? String(r.next_run_at as string | Date) : null,
...
function rowToScheduledTaskRun(r: Record<string, unknown>): ScheduledTaskRun {
  ...
  return {
    ...
    completedAt: r.completed_at ? String(r.completed_at as string | Date) : null,
