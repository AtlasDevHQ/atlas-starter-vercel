 ...
 *
 * 3. **The Next.js security page (`/admin/account-security`).** Rendered
 *    by the frontend, not by the API admin router, so it is reachable
 *    independent of this middleware. (Promoted from
 *    `/admin/settings/security` in #2175; renamed from `/admin/security`
 *    in #2305 to disambiguate from the platform-tier
 *    `/platform/security` adoption-metrics page.)
 *
 ...
 */
export const ENROLLMENT_URL = "/admin/account-security";
