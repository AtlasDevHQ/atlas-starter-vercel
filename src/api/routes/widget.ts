...
/* Mirrors @useatlas/react styles.css .atlas-root tokens — this inline copy
   loads AFTER widget/atlas-widget.css and wins the cascade, so keep --atlas-brand
   (forest) and the primary/ring mapping in sync with packages/react/src/styles.css. */
.atlas-root{--radius:0.625rem;--atlas-brand:oklch(0.4 0.115 158);--atlas-brand-foreground:oklch(0.965 0.016 88);--background:oklch(1 0 0);--foreground:oklch(0.145 0 0);--card:oklch(1 0 0);--card-foreground:oklch(0.145 0 0);--popover:oklch(1 0 0);--popover-foreground:oklch(0.145 0 0);--primary:var(--atlas-brand);--primary-foreground:var(--atlas-brand-foreground);--secondary:oklch(0.97 0 0);--secondary-foreground:oklch(0.205 0 0);--muted:oklch(0.97 0 0);--muted-foreground:oklch(0.556 0 0);--accent:oklch(0.97 0 0);--accent-foreground:oklch(0.205 0 0);--destructive:oklch(0.577 0.245 27.325);--destructive-foreground:oklch(0.577 0.245 27.325);--border:oklch(0.922 0 0);--input:oklch(0.922 0 0);--ring:var(--atlas-brand);--code-bg:oklch(0.14 0.006 167);--code-chrome:oklch(0.185 0.006 167);--code-well:oklch(0.1 0.006 167);--code-fg:oklch(0.86 0 0);--code-muted:oklch(0.62 0 0);--code-border:oklch(1 0 0 / 0.08)}
.dark .atlas-root{--atlas-brand:oklch(0.62 0.12 158);--atlas-brand-foreground:oklch(0.165 0.012 158);--background:oklch(0.145 0 0);--foreground:oklch(0.985 0 0);--card:oklch(0.145 0 0);--card-foreground:oklch(0.985 0 0);--popover:oklch(0.145 0 0);--popover-foreground:oklch(0.985 0 0);--primary:var(--atlas-brand);--primary-foreground:var(--atlas-brand-foreground);--secondary:oklch(0.269 0 0);--secondary-foreground:oklch(0.985 0 0);--muted:oklch(0.269 0 0);--muted-foreground:oklch(0.708 0 0);--accent:oklch(0.269 0 0);--accent-foreground:oklch(0.985 0 0);--destructive:oklch(0.396 0.141 25.723);--destructive-foreground:oklch(0.637 0.237 25.331);--border:oklch(0.269 0 0);--input:oklch(0.269 0 0);--ring:var(--atlas-brand)}
