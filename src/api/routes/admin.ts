...
import { adminBrainTriage } from "./admin-brain-triage";
import { adminBrainVocabulary } from "./admin-brain-vocabulary";
import { adminBrainSlack } from "./admin-brain-slack";
import { adminBrainCoverage } from "./admin-brain-coverage";
import { adminBrainEnrollment } from "./admin-brain-enrollment";
...
mountBoth(admin, "/brain-triage", adminBrainTriage);
mountBoth(admin, "/brain-vocabulary", adminBrainVocabulary);
mountBoth(admin, "/brain-slack", adminBrainSlack);
mountBoth(admin, "/brain-coverage", adminBrainCoverage);
mountBoth(admin, "/brain-enrollment", adminBrainEnrollment);
