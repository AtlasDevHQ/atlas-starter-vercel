...
const unsubscribeRoute = createRoute({
  ...
  responses: {
    ...
    400: { description: "Empty `userId` value", content: { "application/json": { schema: ErrorSchema } } },
    422: { description: "Missing `userId` query parameter — rejected by request validation", content: { "application/json": { schema: ErrorSchema } } },
...
const resubscribeRoute = createRoute({
  ...
  responses: {
    ...
    400: { description: "Malformed JSON body", content: { "application/json": { schema: ErrorSchema } } },
    422: { description: "Missing `userId` in request body — rejected by request validation", content: { "application/json": { schema: ErrorSchema } } },
